<button
    ...
    @class([
        ...
        "bg-white border-solid border border-blue-500 text-blue-500 hover:border-blue-600 hover:text-blue-600 active:border-blue-900 active:text-blue-900 disabled:border-gray-500 disabled:text-gray-500" => $variation === 'outline',
        "py-3" => $size === 'large',
        "py-2.5" => $size === 'medium',
        "py-2" => $size === 'small'
    ])
